...
def _lists_class(link, data):
    from invenio.modules.circulation.lists.on_loan_pending_requests import (
            OnLoanPendingRequests)
    from invenio.modules.circulation.lists.on_shelf_pending_requests import (
            OnShelfPendingRequests)
    from invenio.modules.circulation.lists.overdue_pending_requests import (
